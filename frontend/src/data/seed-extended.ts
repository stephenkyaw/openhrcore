...
export const ATTENDANCE_LAST_DAYS = [
  "2026-05-13",
  "2026-05-14",
  "2026-05-15",
  "2026-05-18",
...
export const OT_REQUESTS = [
  {
    ...
    date: "2026-05-18",
    hours: 2.5,
    reason: "Production hotfix — payment gateway",
    status: "pending",
    approver: "e002",
    submitted: "2026-05-18T19:14:00Z",
  },
  {
    id: "ot2",
    emp: "e007",
    date: "2026-05-15",
    hours: 3,
    reason: "Customer launch prep",
    status: "pending",
    approver: "e002",
    submitted: "2026-05-15T22:02:00Z",
  },
  {
    id: "ot3",
    emp: "e009",
    ...
    status: "approved",
    approver: "e002",
    submitted: "2026-05-12T20:00:00Z",
    decided: "2026-05-13T09:00:00Z",
  },
];
...
export const SALARY_COMPONENTS = [
  ...
  },
  {
    ...
    kind: "statutory",
    calc: "formula",
    notes: "Thai PIT progressive bracket",
  },
  {
    id: "sc5",
    code: "SSO",
    ...
    calc: "percentage",
    value: "5%",
    notes: "Capped ฿750/mo (Thailand SSO)",
  },
  {
    id: "sc6",
    code: "PVD",
...
export const PAYROLL_RUNS = [
  {
    ...
    pay_date: "2026-05-01",
    committed_by: "e001",
    committed_at: "2026-04-29T16:32:00Z",
  },
  {
    id: "pr-2026-05",
    period: "May 2026",
...
export const MAY_PAYSLIP_LINES = EMPLOYEES.slice(0, 14).map((e, i) => {
  const basic =
    [
      120000, 95000, 110000, 145000, 105000, 92000, 105000, 78000, 75000, 65000,
      80000, 62000, 62000, 68000,
    ][i] || 70000;
...
export const JOBS = [
  ...
  {
    id: "j4",
    title: "Engineering Manager — Product Eng",
    dept: "d1",
    loc: "l1",
    hiring_manager: "e001",
    recruiter: "e011",
...
export const CANDIDATES = [
  {
    ...
    applied: "2026-03-14",
    stage: "onsite",
    source: "Referral · Marcus T.",
    rating: 4.5,
    exp: "8y",
    current: "Senior Engineer at Datafold",
    hue: 210,
    salary_ask: 145000,
  },
  {
    ...
    rating: 5,
    exp: "10y",
    current: "Staff Engineer at Mercari",
    hue: 320,
    salary_ask: 160000,
  },
  {
    ...
    rating: 3.5,
    exp: "6y",
    current: "Backend Eng at LINE Man Wongnai",
    hue: 100,
  },
  {
    id: "cn004",
    ...
    rating: 4,
    exp: "7y",
    current: "Senior SWE at SoundCloud",
    hue: 280,
  },
  {
    id: "cn005",
  ...
  },
  {
    ...
    applied: "2026-03-30",
    stage: "rejected",
    source: "Recruiter outbound",
    rating: 2,
    exp: "4y",
    current: "SWE at Grab",
    hue: 60,
    reject_reason: "Below seniority bar",
  },

  {
    ...
    rating: 5,
    exp: "7y",
    current: "Design Lead at Smartnews",
    hue: 340,
    salary_ask: 125000,
  },
  {
    ...
    rating: 4,
    exp: "5y",
    current: "Senior Designer at Lazada",
    hue: 25,
  },
  {
    id: "cn103",
    ...
    rating: 4,
    exp: "6y",
    current: "Product Designer at Spotify",
    hue: 165,
  },
  {
    id: "cn104",
  ...
  },
  {
    ...
    rating: null,
    exp: "6y",
    current: "Senior Designer at Wallapop",
    hue: 18,
  },

  {
    ...
    applied: "2026-04-25",
    stage: "onsite",
    source: "Referral · Daniel O.",
    rating: 4.5,
    exp: "9y",
    current: "Group PM at Wix",
    hue: 200,
    salary_ask: 150000,
  },
  {
...

  {
    ...
    applied: "2026-05-08",
    stage: "interview",
    source: "Referral · Lin C.",
    rating: 4,
    exp: "12y",
    current: "EM at Stripe APAC",
    hue: 200,
  },
  {
    id: "cn302",
...

  {
    ...
    rating: 3.5,
    exp: "3y",
    current: "HR Coordinator at Agoda",
    hue: 340,
  },
  {
    id: "cn402",
...
export const SCORECARDS = [
  {
    ...
    notes:
      "Exceptional system design depth. Has built similar at Mercari. Strong product sense.",
  },
  {
    id: "sc2",
    cand: "cn002",
    ...
    recommend: "strong-yes",
    notes:
      "Best system design interview I have run in 6 months. Trade-offs were articulate.",
  },
  {
    id: "sc3",
    cand: "cn002",
    ...
    rating: 4,
    recommend: "yes",
    notes: "Clean code, idiomatic. Took an extra hint on the second problem.",
  },
  {
    id: "sc4",
    cand: "cn003",
    ...
    recommend: "no",
    notes:
      "Strong on Thai market context but seniority gap shows in design discussion.",
  },
];
