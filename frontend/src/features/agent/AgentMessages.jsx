    ...
    return (
      <div className="space-y-1.5">
        ...
        {view.rows.map((e) => (
          <div
            key={e.id}
            className="bg-card border border-border-soft rounded-md px-2.5 py-2 flex items-center gap-2.5"
          >
            {" "}
  ...
  if (m.role === "agent-thinking") {
    return (
      <div className="flex items-start gap-2 text-[11.5px] text-muted-fg">
        ...
        <span className="rounded-md bg-card border border-border-soft px-2.5 py-1.5">
          {m.content}
        </span>{" "}
      </div>
    );
    ...
    return (
      <div className="ml-7 bg-card border border-border-soft rounded-lg overflow-hidden">
        ...
        <div className="h-8 px-3 bg-accent-soft/35 border-b border-border-soft flex items-center gap-2">
          ...
          <span className="text-[10.5px] text-muted-fg font-mono">
            query
          </span>{" "}
        </div>{" "}
